            ...
            <div class="item">
              <div class="container">
                ...
                <div class="fifth-slide row" style="min-height:500px">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12 animated fadeInLeft">
                    <h1 class="title"><img style="align:center" width="23%" src="assets/img/persuasion_bazaar.png" alt="cartoon depicting methods of persuasion as a carnivalesque marketplace"></h1>
                  </div>
            ...
            <div class="item">
              <div class="container">
                ...
                <div class="seventh-slide row" style="min-height:500px">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12 animated fadeInLeft">
                    <h1 class="title"><img style="align:center" width="30%" src="assets/img/matrix-gaming.jpg" alt="Photograph of Professor Lewis Griffin giving a talk at the Connections UK (Professional Wargaming) Conference 2024. Title slide reads: 'Matrix Gaming with Large Language Models'."></h1>
                  </div>
...
<table id="publications" class="table table-bordered" style="-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;">
  ...
  <tbody>
    <tr>
      <td>2023</td>
      <td>Large Language Models &amp; Influence — DSTL Technical Report/TR149009</td>
      <td><a href="mailto:l.griffin@ucl.ac.uk">Available on request</a></td>
      <td>Lewis Griffin LDG</td>
    ...
    <tr>
      <td>2023</td>
      <td><a href="https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0285333">Warning: Humans Cannot Reliably Detect Speech Deepfakes</a></td>
      <td><a href="#research" data-toggle="tooltip" data-placement="right" title="https://journals.plos.org/plosone/">PLoS One</a></td>
      <td>Kimberly Mai KTM, Sergi Bray SDB, Toby Davies TD, Lewis Griffin LDG</td>
      <td>Deepfakes Speech Audio</td>
    </tr>
    <tr>
      <td>2023</td>
      <td><a href="https://aclanthology.org/2023.sicon-1.3.pdf">Large Language Models respond to Influence like Humans</a></td>
      <td><a href="#research" data-toggle="tooltip" data-placement="right" title="Proceedings of the First Workshop on Social Influence in Conversations (pp. 15-24)">SICon 2023</a></td>
